...
function Footer() {
  const ButtonCvarients1 = {
    init1: { x: "100vw" },
    anim1: { x: 0, transition: { delay: 1, duration: 2 } },
  };
  const ButtonCvarients2 = {
    init1: { x: "100vw" },
    anim1: { x: 0, transition: { delay: 1.5, duration: 2 } },
  };
  const ButtonCvarients3 = {
    init1: { x: "100vw" },
    anim1: { x: 0, transition: { delay: 2, duration: 2 } },
  };
      ...
      >
        <div className="container ml-auto mr-auto p-2">
          <div className="row">
            ...
            <br />
            <motion.div
              className="col col-10 col-lg-3 col-md-5 col-sm-8 col-xsm-10 mx-auto"
              variants={ButtonCvarients1}
              initial="init1"
              animate="anim1"
            >
                  ...
                  <NavLink to="/home">
                    ...
                    >
                      <img
                        ...
                        alt="logo"
                        src="https://reactnativeelements.com/img/logo-icon.svg"
                      />
