...
import { overpara } from "../Components/sideManuItems";
function About() {
  const exitDiv = {
    init: { x: "-100vw" },
  ...
  return (
    <motion.div variants={exitDiv} exit="animat" initial="init" animate="anim">
      <CodeTemplate title="Overview" titlepara={overpara}>
        <PostCodeTemplate
          UseTitle="Using React Native Elements"
          UsePara="Mobile Application development is very common nowadays, 
        ...
        >
          <ul>
            ...
            <li style={{ marginBottom: "10px" }}>
              To provide a responsive and consistent design for both iOS and
              android.
            </li>
            <li style={{ marginBottom: "10px" }}>
              To help beginners in developing stunning and robust themes using
              reusable components without having any prior knowledge of coding.
            </li>
            <li style={{ marginBottom: "10px" }}>
              To make the designing stage simple and less time consuming
              process.
            </li>
            <li style={{ marginBottom: "10px" }}>
              To reduce human effort towrite Code.
            </li>
            <li style={{ marginBottom: "10px" }}>
              To provide fully customized and interactive components for mobile
              applications.
            </li>
